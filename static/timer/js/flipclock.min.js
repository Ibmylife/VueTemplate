...
Base.extend = function (e, t) {
    ...
    var i = r.constructor, s = r.constructor = function () {
        if (!Base._prototyping) if (this._constructing || this.constructor == s) {
...
(function (e) {
    ...
    FlipClock.Base = Base.extend({
        buildDate: "2013-04-16", version: "0.1.2", constructor: function (t, n) {
            typeof t != "object" && (t = {});
            typeof n != "object" && (n = {});
    ...
    FlipClock.Face = FlipClock.Base.extend({
        factory: !1, lists: [], constructor: function (e, t) {
            ...
            n && (r = "");
            var i = ['<span class="' + this.factory.classes.divider + " " + (t ? t : "").toLowerCase() + '">', '<span class="' + this.factory.classes.label + '">' + (t ? t : "") + "</span>", r, "</span>"];
            return e(i.join(""))
            ...
            var r = this;
            if (!n) if (!r.factory.countdown) r.factory.time.time++; else {
            ...
            for (var u = 0; u < t.length; u++) u >= i && r.factory.lists[u].digit != t[u] && r.factory.lists[u].select(t[u])
        }
    });
    FlipClock.List = FlipClock.Base.extend({
        ...
        select: function (e) {
            ...
            this.factory.countdown ? t.is(":last-child") ? this.$obj.find(":first-child").addClass(this.classes.before) : t.next().addClass(this.classes.before) : t.is(":first-child") ? this.$obj.find(":last-child").addClass(this.classes.before) : t.prev().addClass(this.classes.before);
        ...
        createList: function () {
            ...
            for (var n = 0; n < 10; n++) {
                var r = e(['<li data-digit="' + n + '">', '<a href="#">', '<div class="up">', '<div class="shadow"></div>', '<div class="inn">' + n + "</div>", "</div>", '<div class="down">', '<div class="shadow"></div>', '<div class="inn">' + n + "</div>", "</div>", "</a>", "</li>"].join(""));
                this.items.push(r);
                t.append(r)
            }
            return t
    ...
    FlipClock.Time = FlipClock.Base.extend({
        minimumDigits: 0, time: 0, factory: !1, constructor: function (e, t, n) {
            this.base(n);
            this.factory = e;
            t && (this.time = t)
            ...
            var e = this.digitize([this.getDays(), this.getHours(!0), this.getMinutes(!0), this.getSeconds(!0)]);
            return e
        }, getDays: function (e) {
            ...
            var e = new Date, t = this.digitize([e.getHours(), e.getMinutes(), e.getSeconds()]);
            return t
            ...
            var e = new Date, t = e.getHours(), n = t > 12 ? "PM" : "AM",
    ...
    FlipClock.Timer = FlipClock.Base.extend({
        callbacks: {
            ...
            stop: !1,
            reset: !1
        }, count: 0, factory: !1, interval: 1e3, constructor: function (e, t) {
            this.base(t);
            this.factory = e;
...
(function (e) {
    FlipClock.HourlyCounterFace = FlipClock.Face.extend({
        constructor: function (e, t) {
            ...
            var r = this, i = this.factory.$wrapper.find("ul"), s = [];
            n = n ? n : this.factory.time.getHourCounter();
            n.length > i.length && e.each(n, function (e, t) {
                s.push(r.createList(t))
            });
            this.factory.lists = s;
            e(this.createDivider("Seconds")).insertBefore(this.factory.lists[this.factory.lists.length - 2].$obj);
            e(this.createDivider("Minutes")).insertBefore(this.factory.lists[this.factory.lists.length - 4].$obj);
            t || e(this.createDivider("Hours", !0)).insertBefore(this.factory.lists[0].$obj);
...
(function (e) {
    FlipClock.TwentyFourHourClockFace = FlipClock.Face.extend({
        dividers: [], build: function (t) {
            var n = this, r = this.factory.$wrapper.find("ul");
            t = t ? t : this.factory.time.time || this.factory.time.getMilitaryTime();
            t.length > r.length && e.each(t, function (e, t) {
                n.factory.lists.push(n.createList(t))
            });
            this.dividers.push(this.createDivider());
            this.dividers.push(this.createDivider());
            e(this.dividers[0]).insertBefore(this.factory.lists[this.factory.lists.length - 2].$obj);
            e(this.dividers[1]).insertBefore(this.factory.lists[this.factory.lists.length - 4].$obj);
            this._clearExcessDigits();
            this.autoStart && this.start()
        }, flip: function (e) {
...
(function (e) {
    FlipClock.TwelveHourClockFace = FlipClock.TwentyFourHourClockFace.extend({
        ...
        build: function (t) {
            var n = this;
            t = t ? t : this.factory.time.time ? this.factory.time.time : this.factory.time.getTime();
            this.base(t);
            this.meridiumText = this._isPM() ? "PM" : "AM";
            this.meridium = e(['<ul class="flip-clock-meridium">', "<li>", '<a href="#">' + this.meridiumText + "</a>", "</li>", "</ul>"].join(""));
...
(function (e) {
    FlipClock.DailyCounterFace = FlipClock.Face.extend({
        constructor: function (e, t) {
            ...
            e(this.createDivider("Seconds")).insertBefore(this.factory.lists[this.factory.lists.length - 2].$obj);
            e(this.createDivider("Minutes")).insertBefore(this.factory.lists[this.factory.lists.length - 4].$obj);
            e(this.createDivider("Hours", !0)).insertBefore(this.factory.lists[this.factory.lists.length - 6].$obj);
            e(this.createDivider("Days", !0)).insertBefore(this.factory.lists[0].$obj);
            this._clearExcessDigits();
            this.autoStart && this.start()
        }, flip: function (e, t) {
